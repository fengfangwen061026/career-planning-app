  ...
  return (
    <>
      <div className="scroll-body" style={{ padding: '12px 12px 0' }}>
        ...
        {/* 搜索框 */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '7px 10px', background: '#F9FAFB', border: '0.5px solid #D1D5DB', borderRadius: 20, marginBottom: 8 }}>
          ...
          <input
            ...
            style={{ flex: 1, border: 'none', outline: 'none', background: 'transparent', fontSize: 10, color: '#374151', fontFamily: 'inherit' }}
          />
        </div>
          ...
          {FILTERS.map(f => (
            <span
              ...
              style={{
                ...
                borderRadius: 20, fontSize: 8, fontWeight: filter === f ? 700 : 400,
        ...
        {filtered.map(job => (
          <div
            ...
            style={{
              ...
              padding: '9px 10px', background: 'white', border: '0.5px solid #E5E7EB',
              borderRadius: 10, marginBottom: 7, cursor: 'pointer', position: 'relative',
            }}
          >
            {/* 图标块 */}
            <div style={{
              width: 26, height: 26, borderRadius: 7, background: job.color,
            ...
            {/* 综合分 */}
            <div style={{ fontSize: 18, fontWeight: 900, letterSpacing: '-0.8px', color: job.scoreColor, flexShrink: 0, lineHeight: 1 }}>
              {job.score}
            </div>
