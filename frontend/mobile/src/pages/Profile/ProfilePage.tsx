  ...
  return (
    <>
      <div className="scroll-body" style={{ padding: '12px 12px 0' }}>
        ...
        {/* 综合数据卡 */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'white', border: '0.5px solid #E5E7EB', borderRadius: 11, padding: '10px 12px', marginBottom: 8 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 5 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 800, color: '#D97706' }}>{completeness}%</span>
            </div>
            <div style={{ height: 4, background: '#F3F4F6', borderRadius: 2, overflow: 'hidden', marginBottom: 7 }}>
              <div style={{ width: `${completeness}%`, height: '100%', background: '#D97706', borderRadius: 2 }} />
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span style={{ fontSize: 9, color: '#6B7280' }}>高匹配岗位</span>
              <span style={{ fontSize: 11, fontWeight: 800, color: '#10B981' }}>14个</span>
            </div>
          </div>
        </div>
        ...
        {/* 实习&项目卡 */}
        <div className="card">
          <div className="card-hd"><div className="card-hd-bar" style={{ background: '#10B981' }} />实习 &amp; 项目</div>
          ...
          <div className="notice">⚠ 两个项目均缺少量化成果，建议补充数据指标</div>
        </div>
