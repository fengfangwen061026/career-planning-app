...
import { BorderOutlined, AppstoreOutlined, ReloadOutlined, TableOutlined } from '@ant-design/icons';
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        ...
        <div className="flex flex-col gap-3 xl:items-end">
          ...
          <div className="flex flex-wrap gap-2 text-xs text-slate-500">
            <Tag color="blue">实线: 晋升</Tag>
            <Tag color="green">虚线: 转岗</Tag>
            <Tag>灰线: 关联</Tag>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 border-t border-slate-100 pt-3">
        <div className="mb-2 text-xs font-semibold uppercase tracking-wide text-slate-500">职级图例</div>
